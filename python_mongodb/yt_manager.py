...
client = MongoClient("connenction string", tlsAllowInvalidCertificates=True)
# Not a good idea to include id and password in code files
#  tlsAllowInvalidCertificates=True - Not a good way to handle ssl

print(client)
db = client["ytmanager"] # create or use existing database named ytmanager
video_collection = db["videos"] # create or use existing collection named videos
